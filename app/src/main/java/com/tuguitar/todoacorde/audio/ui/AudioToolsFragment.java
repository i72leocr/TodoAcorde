        ...
        viewPager.registerOnPageChangeCallback(new ViewPager2.OnPageChangeCallback() {
            ...
            public void onPageSelected(int position) {
                if (position == 0) {
                    ...
                    // Metrónomo
                    safeCallTunerStop();
                    // Si el metrónomo tiene play automático puedes llamarlo aquí también
                    // metronomeFragment.startIfNeeded();
                }
            }
        });

        // Arrancar detección inicial con delay para evitar que el fragmento no esté attached aún

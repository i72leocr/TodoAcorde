...
public class NoteUtils {
    ...
    // ---------------------------------------------------------------------------------------------
    // Utilidades comunes de nombres de nota (enarmonía / octava)
    // ---------------------------------------------------------------------------------------------
    ...
    public static String normalizeToSharp(String s) {
        if (s == null) return "";
        // Unificar: quitar octava y usar ASCII, mayúsculas
        s = stripOctave(s)
                .replace('♭', 'B')
                .replace('♯', '#')
                .trim()
        ...
        // Ajustes enharmónicos típicos primero
        switch (s) {
            case "E#": return "F";
            case "B#": return "C";
            case "CB": return "B";
        ...
        // Si ya está en el set estándar, lo devolvemos tal cual
        switch (s) {
            case "C": case "C#":
            case "D": case "D#":
            case "E":
        ...
        // Fallback: retornar tal cual (ya uppercase y sin octava)
        return s;
    }

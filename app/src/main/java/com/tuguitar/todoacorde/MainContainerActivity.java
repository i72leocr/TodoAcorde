...
public class MainContainerActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ----- Insets / Edge-to-edge bindings -----
        // Contenedor donde se pintan los fragments
        final View fragmentContainer = findViewById(R.id.fragment_container);
        // Barra inferior
        bottomNavigationView = findViewById(R.id.bottom_navigation);

        // 1) TOP: status bar + extra fijo (8dp) para que mantengas un padding arriba
        if (fragmentContainer != null) {
            ...
            ViewCompat.setOnApplyWindowInsetsListener(fragmentContainer, (v, insets) -> {
                ...
                // top: status bar + extra, bottom: nav/gestures
        ...
        // 2) BOTTOM NAV: sitúala justo por encima del gesto/nav bar
    ...
    // Activa edge-to-edge sin ocultar barras; permite gesto para mostrarlas si las ocultas en el futuro
